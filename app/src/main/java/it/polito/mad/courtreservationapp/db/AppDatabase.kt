...
abstract class AppDatabase : RoomDatabase() {
    ...
    abstract fun sportMasteryDao(): SportMasteryDao
...
//                    "app_database"
//                ).build()
                val instance = Room.databaseBuilder(context, AppDatabase::class.java, "AppDatabase").createFromAsset("database/app.db").build()
                INSTANCE = instance
